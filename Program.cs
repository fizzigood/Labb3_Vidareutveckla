...
namespace Labb3_Vidareutveckla
{
    ...
    // Implementerar en specifik varm dryck, i detta fall vatten, med tillbyggda klasser för kaffe, cappuccino och choklad
    ...
    internal class ChocolateFactory : IWarmDrinkFactory
    {
        public IWarmDrink Prepare(int total)
        {
            Console.WriteLine($"Mix {total} ml hot chocolate"); // Utskrift av mängden choklad som blandas
    ...
    public class WarmDrinkMachine
    {
        ...
        public WarmDrinkMachine()
        {
            ...
            RegisterFactory<ChocolateFactory>("Hot Chocolate"); // Registrerar fabriken för choklad
        }
